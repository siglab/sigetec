...
exports.statusChangeTrigger = functions.database.ref('/technologies/{technologyId}').onWrite((change, context) => {
                  ...
                  if (user && user !== '') {
                    ...
                    if (change.before.val().status == 'En diligencia' && technology.status == 'Registrada') {
                      ...
                      message =
                        'La tecnología titulada "' +
                        technology.name +
                        '" ha sido registrada en el sistema con el id ' +
                        technology['technologyId'] +
                        '.' +
                        '\n\nEste es un mensaje autogenerado. Por favor no intente responder este mensaje.';
                      admin
